        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-8">
          {juniorHighBooks.map((book) => (
            <div key={book.id} className="relative flex flex-col text-zinc-700 bg-white shadow-md bg-clip-border rounded-xl w-full max-w-sm mx-auto hover:shadow-lg transition-shadow">
              ...
              <div className="relative mx-4 mt-4 overflow-visible text-zinc-700 bg-gradient-to-t from-white via-yellow-200/40 to-yellow-500/40 bg-clip-border rounded-xl min-h-[300px] flex items-center justify-center p-4" style={{
